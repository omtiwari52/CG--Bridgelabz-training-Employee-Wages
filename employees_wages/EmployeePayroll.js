...
const emp1 = new EmployeePayroll(101, "HarshVeer", 150, "F", "2023-05-10");
const emp2 = new EmployeePayroll(102, "Omm Tiwari", 9000000, "M", "2022-11-15");
const emp3 = new EmployeePayroll(103, "om", 600000, "M", "2024-01-20"); 
const emp4 = new EmployeePayroll(103, "Durgesh", 0 , "M", "2021-01-20"); 
const emp5 = new EmployeePayroll(103, "Aryan", -300, "M", "2003-01-20"); 
const emp6 = new EmployeePayroll(103, "Bipin", 60000, "T", "2027-01-20"); 
